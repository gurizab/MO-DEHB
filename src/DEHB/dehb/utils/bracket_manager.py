...
class SHBracketManager(object):
    ...
    def __init__(self, n_configs, budgets, bracket_id=None):
        ...
        for i, budget in enumerate(budgets):
            ...
            # _sh_bracket keeps track of jobs/configs that have been run and final_results retrieved for
            ...
            #   and is queued/running and the bracket needs to be paused till final_results are retrieved
    ...
    def register_job(self, budget):
        ...
        final_results necessarily. This feature can be leveraged to run brackets asynchronously.
        """
        assert budget in self.budgets
    ...
    def _is_rung_waiting(self, rung):
        """ Returns True if at least one job is still pending/running and waits for final_results
        """
    ...
    def previous_rung_waits(self):
        """ Returns True if none of the rungs < current rung is waiting for final_results
        """

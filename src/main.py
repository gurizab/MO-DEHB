...
def main(model_config,
    ...
    cv = StratifiedKFold(n_splits=3, random_state=123, shuffle=True)  # to make CV splits consistent
    ...
    for train_set, val_set in zip(train_sets, val_sets):
        ...
        for epoch in range(num_epochs):
            ...
            logging.info('Precision %f', score_precision)
...
if __name__ == '__main__':
    ...
    with open("/home/guri/Desktop/AutoML_Project/automl-ss21-final-project-gurizab/src/opt_cfg.json", 'r') as f:
        opt_cfg = json.load(f)
